...
<head>
    ...
    <link rel="icon" href="assets/img/terro_logo_transparent_bg.png">
	<title>Terro Protocol</title>
            ...
            <main id="main-content">
                <div class="ts-content-wrapper">
                    <div class="row">
                        <!--Page Title-->
                        <div class="col-md-6">
                            <h1>Get Ready For Our<br>TRRT Launch</h1>
                            <p>
                                Terro token is a decentralized cryptocurrency that is built on the Solana blockchain.
                                It is a decentralized token that is built on the Solana blockchain.
                                Join the community and get ready for our launch.

                            </p>
                            <a href="https://docs.terroprotocol.tech/whitepaper/abstract" class="btn btn-primary mr-2 ts-open-side-panel">Whitepaper</a>
                            <a href="https://vimeo.com/63502573" class="btn btn-outline-light "><i class="fa fa-play mr-2"></i>Video</a>
                        </div>
                        <!--end col-md-6-->
                        <!--Count Down-->
                        <div class="col-md-6">
                            <div class="text-center my-4">
                                <div id="countdown" class="ts-count-down" data-date="August 30, 2022 12:00:00" data-direction="down"></div>
                                <!--end ts-count-down-->
                            </div>
                        </div>
                        <!--end col-md-6-->
                ...
                <div class="clearfix py-4">
                    <div class="float-none float-sm-left">
                        <div class="ts-social-icons">
                            ...
                            <a href="https://docs.terroprotocol.tech" class="fab fa-book"></a>
                        </div>
                    </div>
                    <!--end social-icons-->
                    <div class="float-none float-sm-right text-left text-sm-right ts-opacity__50">
                        <small>© 2022 Terro Protocol, All Rights Reserved</small>
                    </div>
                    <!--end text-left-->
                </div>
                <!--end clearfix-->
